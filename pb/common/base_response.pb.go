...
type BaseResponse struct {
	...
	StatuseCode      int32                  `protobuf:"varint,1,opt,name=statuse_code,json=statuseCode,proto3" json:"statuse_code,omitempty"`
...
func (x *BaseResponse) GetStatuseCode() int32 {
	if x != nil {
		return x.StatuseCode
	}
	return 0
}
...
const file_common_base_response_proto_rawDesc = "" +
	...
	"\fBaseResponse\x12!\n" +
	"\fstatuse_code\x18\x01 \x01(\x05R\vstatuseCode\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x19\n" +
	"\bis_error\x18\x03 \x01(\bR\aisError\x12D\n" +
	"\x11validation_errors\x18\x04 \x03(\v2\x17.common.ValidationErrorR\x10validationErrors\"I\n" +
	"\x0fValidationError\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescriptionB4Z2github.com/irvandMR/go-grpc-ecommerce-BE/pb/commonb\x06proto3"
...
var file_common_base_response_proto_depIdxs = []int32{
	1, // 0: common.BaseResponse.validation_errors:type_name -> common.ValidationError
