...
import (
	...
	common "github.com/irvandMR/go-grpc-ecommerce-BE/pb/common"
...
type CreateProductReqauest struct {
...
func (x *CreateProductReqauest) Reset() {
	*x = CreateProductReqauest{}
	mi := &file_product_product_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateProductReqauest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateProductReqauest) ProtoMessage() {}

func (x *CreateProductReqauest) ProtoReflect() protoreflect.Message {
	mi := &file_product_product_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use CreateProductReqauest.ProtoReflect.Descriptor instead.
func (*CreateProductReqauest) Descriptor() ([]byte, []int) {
	return file_product_product_proto_rawDescGZIP(), []int{0}
}

func (x *CreateProductReqauest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateProductReqauest) GetDescription() string {
	if x != nil {
...
func (x *CreateProductReqauest) GetPrice() float64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *CreateProductReqauest) GetImageFileName() string {
	if x != nil {
...
const file_product_product_proto_rawDesc = "" +
	"\n" +
	"\x15product/product.proto\x12\aproduct\x1a\x1acommon/base_response.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x01\n" +
	"\x15CreateProductReqauest\x12\x1e\n" +
	...
	"\x02id\x18\x02 \x01(\tR\x02id2a\n" +
	"\x0eProductService\x12O\n" +
	"\rCreateProduct\x12\x1e.product.CreateProductReqauest\x1a\x1e.product.CreateProductResponseB5Z3github.com/irvandMR/go-grpc-ecommerce-BE/pb/productb\x06proto3"
...
var file_product_product_proto_goTypes = []any{
	(*CreateProductReqauest)(nil), // 0: product.CreateProductReqauest
...
var file_product_product_proto_depIdxs = []int32{
	...
	0, // 1: product.ProductService.CreateProduct:input_type -> product.CreateProductReqauest
